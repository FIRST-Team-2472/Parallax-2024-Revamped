...
public class CommandSequences {
    ...
    public Command threeinspeakerfrompositionone(SwerveSubsystem swerveSubsystem){
        ...
        return new SequentialCommandGroup(
                genratePath(swerveSubsystem, List.of(importantNodes[4].getPositivePoint()), importantNodes[5])
            );
        }
    ...
    private static Command genratePath(SwerveSubsystem swerveSubsystem,

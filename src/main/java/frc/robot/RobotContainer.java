...
public class RobotContainer {
  ...
  fiveNoteFromPosition2 = "Five note auto collecting four notes closest to amp", threeNoteMiddle = "Three notes starting center", AutoOne = "AutoOne";
  ...
  public Command getAutonomousCommand() {
    System.out.println("Autos Begun");
      ...
      if(m_autoSelected == AutoOne)
        return AutoBuilder.buildAuto(AutoOne);
